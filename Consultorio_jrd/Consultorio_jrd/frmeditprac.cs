...

{
    ...
    public partial class frmeditprac: Form
    {
        string secres;
        public SqlConnection cn;
        public Boolean s = true;
        
        public frmeditprac(string nombre)
        {
            secres=nombre;
            InitializeComponent();
        ...
        public DataTable Mostrar()
        {
            ...
            cn.Open();
            comando = new SqlCommand("SELECT cedula,nombre,apellido,correo,telefono,cod_asesor FROM Practicante", cn);
        ...
        private void btninsertar_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        cn.Open();
            //        SqlCommand comando = new SqlCommand("INSERT INTO Practicante VALUES('" + txtCedula.Text + "','" + txtNombre.Text + "','" + txtApellido.Text + "','" + txtCorreo.Text + "','" + txtTelefono.Text + "','" + txtcodigoasesor.Text + "','" + txtcodigoasesor.Text + "')", cn);
            ...
            if (s == true)
                {
                        ...
                        cn.Open();
                        SqlCommand comando = new SqlCommand("update practicante set cedula='" + txtCedula.Text + "', nombre='" + txtNombre.Text + "', apellido='" + txtApellido.Text + "', correo='" + txtCorreo.Text + "', telefono='" + txtTelefono.Text + "', cod_asesor='" + txtcodigoasesor.Text +"'where cedula='" + txtCedula.Text + "'", cn);
                        comando.ExecuteNonQuery();
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            if (dtgdatos.SelectedRows.Count > 0)
            {
                ...
                txtcodigoasesor.Text = dtgdatos.CurrentRow.Cells["cod_asesor"].Value.ToString();
            }
            else
            {
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            if (dtgdatos.SelectedRows.Count > 0)
            {
               ...
               respuesta = MessageBox.Show("¿Está seguro que desea eliminar el registro seleccionado ?","Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
                ...
                {
                    cn.Open();
                    SqlCommand eliminar = new SqlCommand("delete from Practicante where cedula='" + dtgdatos.CurrentRow.Cells["cedula"].Value.ToString() + "'", cn);
